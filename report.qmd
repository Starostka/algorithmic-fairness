...
For the data preparation we apply one-hot encoding for non numeric variables and split the dataset into its test, train and validation sets respectively.
```{python}
